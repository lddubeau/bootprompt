...
describe("bootshine.dialog", function() {
  ...
  describe("when creating a minimal dialog", function() {
    beforeEach(function() {
      return this.dialog = bootshine.dialog({
        message: "test"
      });
    });
    it("adds the bootshine class to the dialog", function() {
      return expect(this.dialog.hasClass("bootshine")).to.be["true"];
    });
    ...
    it("shows the expected message", function() {
      return expect(this.text(".bootshine-body")).to.equal("test");
    });
    ...
    beforeEach(function() {
      return this.create = (function(_this) {
        return function(button) {
          ...
          return _this.dialog = bootshine.dialog({
            message: "test",
            buttons: {
              one: button
            }
