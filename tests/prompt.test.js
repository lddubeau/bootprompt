      ...
      describe("where the argument is not an object", function () {
        beforeEach(function () {
          return this.create = function () {
            return bootshine.prompt("What is your name?");
          };
        });
      ...
      return describe("where the argument is an object", function () {
        beforeEach(function () {
          ...
          return this.create = (function (_this) {
            return function () {
              return _this.dialog = bootshine.prompt(_this.options);
            };
          })(this);
        });
        ...
        return describe("with a title and a callback", function () {
          ...
          it("applies the bootshine-prompt class to the dialog", function () {
            return expect(this.dialog.hasClass("bootshine-prompt")).to.be["true"];
          });
          ...
          return it("adds the correct button classes", function () {
            ...
            expect(this.dialog.find(".btn:first").hasClass("bootshine-cancel")).to.be["true"];

            expect(this.dialog.find(".btn:last").hasClass("btn-primary")).to.be["true"];
            return expect(this.dialog.find(".btn:last").hasClass("bootshine-accept")).to.be["true"];
          });
        });
      });
    });
    return describe("with two arguments", function () {
      describe("where the second argument is not a function", function () {
        beforeEach(function () {
          return this.create = (function (_this) {
            return function () {
              return _this.dialog = bootshine.prompt("What is your name?", "callback here");
            };
          })(this);
        });
        return it("throws an error requiring a callback", function () {
      ...
      return describe("where the second argument is a function", function () {
        beforeEach(function () {
          return this.create = (function (_this) {
            return function () {
              return _this.dialog = bootshine.prompt("What is your name?", function () {
                return true;
              });
            };
          })(this);
  ...
  describe("configuration options tests", function () {
    ...
    describe("setting show to false", function () {
      beforeEach(function () {
        ...
        sinon.stub(bootshine, "dialog", (function (_this) {
          return function () {
            return {
              on: function () { },
              off: function () { },
    ...
    describe("setting inputType text", function () {
      ...
      describe("without default value", function () {
        ...
        return it("has proper class", function () {
          expect(this.find("input[type='text']").hasClass("bootshine-input")).to.be.ok;
          return expect(this.find("input[type='text']").hasClass("bootshine-input-text")).to.be.ok;
        });
      });
    ...
    describe("setting inputType textarea", function () {
      ...
      describe("without default value", function () {
        ...
        return it("has proper class", function () {
          expect(this.find("textarea").hasClass("bootshine-input")).to.be.ok;
          return expect(this.find("textarea").hasClass("bootshine-input-textarea")).to.be.ok;
        });
      });
      describe("with default value", function () {
        beforeEach(function () {
    ...
    describe("setting inputType email", function () {
      ...
      describe("without default value", function () {
        ...
        return it("has proper class", function () {
          expect(this.find("input[type='email']").hasClass("bootshine-input")).to.be.ok;
          return expect(this.find("input[type='email']").hasClass("bootshine-input-email")).to.be.ok;
        });
      });
      describe("with default value", function () {
        beforeEach(function () {
    ...
    describe("setting inputType password", function () {
      ...
      describe("without default value", function () {
        ...
        return it("has proper class", function () {
          expect(this.find("input[type='password']").hasClass("bootshine-input")).to.be.ok;
          return expect(this.find("input[type='password']").hasClass("bootshine-input-password")).to.be.ok;
        });
      });
      describe("with default value", function () {
        beforeEach(function () {
    ...
    describe("setting inputType select", function () {
      ...
      describe("with valid options", function () {
        ...
        it("has proper class", function () {
          expect(this.find("select").hasClass("bootshine-input")).to.be.ok;
          return expect(this.find("select").hasClass("bootshine-input-select")).to.be.ok;
        });
    ...
    describe("setting inputType checkbox", function () {
      ...
      return describe("with options", function () {
        ...
        it("has proper class", function () {
          expect(this.find("input[type='checkbox']").hasClass("bootshine-input")).to.be.ok;
          return expect(this.find("input[type='checkbox']").hasClass("bootshine-input-checkbox")).to.be.ok;
        });
    ...
    describe("setting inputType radio", function () {
      ...
      return describe("with options", function () {
        ...
        it("has proper class", function () {
          expect(this.find("input[type='radio']").hasClass("bootshine-input")).to.be.ok;
          return expect(this.find("input[type='radio']").hasClass("bootshine-input-radio")).to.be.ok;
        });
    ...
    describe("setting inputType date", function () {
      ...
      describe("without default value", function () {
        ...
        return it("has proper class", function () {
          expect(this.find("input[type='date']").hasClass("bootshine-input")).to.be.ok;
          return expect(this.find("input[type='date']").hasClass("bootshine-input-date")).to.be.ok;
        });
      });
      describe("with default value", function () {
        beforeEach(function () {
    ...
    describe("setting inputType time", function () {
      ...
      describe("without default value", function () {
        ...
        return it("has proper class", function () {
          expect(this.find("input[type='time']").hasClass("bootshine-input")).to.be.ok;
          return expect(this.find("input[type='time']").hasClass("bootshine-input-time")).to.be.ok;
        });
      });
      describe("with default value", function () {
        beforeEach(function () {
    ...
    return describe("setting inputType number", function () {
      ...
      describe("without default value", function () {
        ...
        return it("has proper class", function () {
          expect(this.find("input[type='number']").hasClass("bootshine-input")).to.be.ok;
          return expect(this.find("input[type='number']").hasClass("bootshine-input-number")).to.be.ok;
        });
      });
      describe("with default value", function () {
        beforeEach(function () {
    ...
    return describe("setting inputType range", function () {
      ...
      describe("without default value", function () {
        ...
        return it("has proper class", function () {
          expect(this.find("input[type='range']").hasClass("bootshine-input")).to.be.ok;
          return expect(this.find("input[type='range']").hasClass("bootshine-input-range")).to.be.ok;
        });
      });
      describe("with default value", function () {
        beforeEach(function () {
  ...
  return describe("callback tests", function () {
    ...
    describe("with a simple callback", function () {
      ...
      describe("when entering no value in the text input", function () {
        describe("when dismissing the dialog by clicking OK", function () {
          beforeEach(function () {
            return this.dialog.find(".bootshine-accept").trigger("click");
          });
        ...
        return describe("when submitting the form", function () {
          beforeEach(function () {
            return this.dialog.find(".bootshine-form").trigger("submit");
          });
      ...
      describe("when entering a value in the text input", function () {
        beforeEach(function () {
          return this.dialog.find(".bootshine-input").val("Test input");
        });
        describe("when dismissing the dialog by clicking OK", function () {
          beforeEach(function () {
            return this.dialog.find(".bootshine-accept").trigger("click");
      ...
      describe("when dismissing the dialog by clicking Cancel", function () {
        beforeEach(function () {
          return this.dialog.find(".bootshine-cancel").trigger("click");
        });
        it("should invoke the callback", function () {
          return expect(this.callback).to.have.been.called;
        });
    ...
    describe("with a default value", function () {
      ...
      it("populates the input with the default value", function () {
        return expect(this.dialog.find(".bootshine-input").val()).to.equal("Bob");
      });
      describe("when entering no value in the text input", function () {
        describe("when dismissing the dialog by clicking OK", function () {
          beforeEach(function () {
      ...
      return describe("when entering a value in the text input", function () {
        beforeEach(function () {
          return this.dialog.find(".bootshine-input").val("Alice");
        });
        describe("when dismissing the dialog by clicking OK", function () {
          beforeEach(function () {
            return this.dialog.find(".bootshine-accept").trigger("click");
    ...
    describe("with a placeholder", function () {
      beforeEach(function () {
        this.callback = sinon.spy();
        return this.dialog = bootshine.prompt({
          title: "What is your name?",
      ...
      return it("populates the input with the placeholder attribute", function () {
        return expect(this.dialog.find(".bootshine-input").attr("placeholder")).to.equal("e.g. Bob Smith");
      });
    });
    ...
    describe("with inputType select", function () {
      describe("without a default value", function () {
        ...
        it("has correct number values in list", function () {
          return expect(this.find(".bootshine-input-select option").length).to.equal(5);
        });
        describe("when dismissing the dialog by clicking OK", function () {
          beforeEach(function () {
            return this.dialog.find(".bootshine-accept").trigger("click");
      ...
      return describe("with a default value", function () {
        ...
        it("specified option is selected", function () {
          return expect(this.dialog.find(".bootshine-input-select").val()).to.equal("1");
        });
        describe("when dismissing the dialog by clicking OK", function () {
          beforeEach(function () {
            return this.dialog.find(".bootshine-accept").trigger("click");
        ...
        return describe("when changing the selected option and dismissing the dialog by clicking OK", function () {
          beforeEach(function () {
            this.dialog.find(".bootshine-input-select").val(3);
            return this.dialog.find(".bootshine-accept").trigger("click");
          });
          it("should invoke the callback", function () {
            return expect(this.callback).to.have.been.called;
    ...
    describe("with inputType email", function () {
      describe("without a default value", function () {
        ...
        return describe("when entering a value in the email input", function () {
          beforeEach(function () {
            return this.dialog.find(".bootshine-input-email").val("john@smith.com");
          });
          describe("when dismissing the dialog by clicking OK", function () {
            beforeEach(function () {
              return this.dialog.find(".bootshine-accept").trigger("click");
      ...
      return describe("with a default value", function () {
        ...
        return describe("when changing a value in the email input", function () {
          beforeEach(function () {
            return this.dialog.find(".bootshine-input-email").val("smith@john.com");
          });
          describe("when dismissing the dialog by clicking OK", function () {
            beforeEach(function () {
              return this.dialog.find(".bootshine-accept").trigger("click");
